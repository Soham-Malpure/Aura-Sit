...
import { SessionReportTemplate } from "./components/dashboard/SessionReportTemplate";
        ...
        {activeTab === "live" ? (
          ...
          <div style={{ padding: "0 20px" }}>
            ...
            <div style={{ overflow: "hidden", display: "flex", justifyContent: "center", width: "100%" }}>
              {/* Force absolute positioning layout constraints to make inline block scale properly */}
